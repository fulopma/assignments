...
///     Non-escaping closure get passed in a function and get reclaimed by memory once complete. Escaping closures avoid getting reclaimed in memory.
...
/// 9. What is generics?
///     Generics allow you to design classes, structs, and functions to be become specific for any datatype.
/// 10. Enum, protocol, collection type? Are they value type or reference type? (DYR)
///     Enum and the collections are value type. Protocols depend whether a struct or class in conforming it and will take the type of the struct or class.
///
